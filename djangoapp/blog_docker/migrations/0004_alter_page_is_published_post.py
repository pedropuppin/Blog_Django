    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='blog_docker.category')),
                ('tag', models.ManyToManyField(blank=True, default='', to='blog_docker.tag')),
            ],
            options={
                'verbose_name': 'Post',
